...
IterableSparseMatrix::IterableSparseMatrix (size_t a, size_t b)
{
...
int IterableSparseMatrix::get(size_t isk_1, size_t isk_2) const
{
    for (int i = 0; i < cnt; ++i)
    {
...
IteratorRow IterableSparseMatrix::iter_rows(size_t r_n)
{
...
IteratorColumn IterableSparseMatrix::iter_columns(size_t c_n)
{
    //(Element* elem, size_t r_cur, size_t c_cur, size_t r_num, size_t r_size): 
